...
get_trash_configs_gmp (gvm_connection_t *, credentials_t *, params_t *params,
                       cmd_response_data_t *);
char *
get_trash_credentials_gmp (gvm_connection_t *, credentials_t *,
...
get_trash_overrides_gmp (gvm_connection_t *, credentials_t *, params_t *params,
                         cmd_response_data_t *);
char *
get_trash_permissions_gmp (gvm_connection_t *, credentials_t *,
                           params_t *params, cmd_response_data_t *);
char *
...
char *
get_agent_group_gmp (gvm_connection_t *, credentials_t *, params_t *,
                     cmd_response_data_t *);

char *
create_agent_group_gmp (gvm_connection_t *, credentials_t *, params_t *,
                        cmd_response_data_t *);

char *
save_agent_group_gmp (gvm_connection_t *, credentials_t *, params_t *,
                      cmd_response_data_t *);
...
get_oci_image_target_gmp (gvm_connection_t *, credentials_t *, params_t *,
                          cmd_response_data_t *);
char *
get_oci_image_targets_gmp (gvm_connection_t *, credentials_t *, params_t *,
                           cmd_response_data_t *);
char *
export_oci_image_targets_gmp (gvm_connection_t *, credentials_t *, params_t *,
                              cmd_response_data_t *);
char *
export_oci_image_target_gmp (gvm_connection_t *, credentials_t *, params_t *,
                             cmd_response_data_t *);
char *
create_oci_image_target_gmp (gvm_connection_t *, credentials_t *, params_t *,
                             cmd_response_data_t *);
char *
delete_oci_image_target_gmp (gvm_connection_t *, credentials_t *, params_t *,
                             cmd_response_data_t *);
char *
