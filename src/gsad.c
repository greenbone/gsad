...
main (int argc, char **argv)
{
  ...
  gsad_settings_set_http_cross_origin_embedder_policy (
    gsad_global_settings, gsad_args_get_http_coep (gsad_args));
  gsad_settings_set_http_cross_origin_opener_policy (
    gsad_global_settings, gsad_args_get_http_coop (gsad_args));
  gsad_settings_set_http_cross_origin_resource_policy (
